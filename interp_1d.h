...
struct Base_interp
{
	...
	//n: length of xx
	//mm: length of vector surrounding x
	const Doub *xx, *yy;
	Base_interp(){};// added by H. Wang
	...
	inline Int locate(const Doub x);
	inline Int hunt(const Doub x);
...
struct Spline_interp : Base_interp
{
	...
	inline void sety2(const Doub *xv, const Doub *yv, Doub yp1, Doub ypn);
